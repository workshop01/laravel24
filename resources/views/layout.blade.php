                        ...
                        <div class="right-bar">
                            ...
                            <div class="sinlge-bar shopping">
                                <a href="#" class="single-icon"><i class="ti-bag"></i> <span
                                        class="total-count">{{ count($card) }}</span></a>
                                <!-- Shopping Item -->
                                <div class="shopping-item">
                                    <div class="dropdown-cart-header">
                                        <span>{{ count($card) }} Items</span>
                                        <a href="{{route('card')}}">View Cart</a>
                                    </div>
                                ...
                                <div class="all-category">
                                    ...
                                    <ul class="main-category">
                                        @foreach ($categories as $categ)
                                            <li><a href="shop-grid.html">{{ $categ->title }}</a></li>
                                        @endforeach
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    <div class="navbar-collapse">
                                        <div class="nav-inner">
                                            <ul class="nav main-menu menu navbar-nav">
                                                ...
                                                <li><a href="{{ route('shop') }}">Shop<i
                                                            class="ti-angle-down"></i><span
                                                            class="new">New</span></a>
                                                    <ul class="dropdown">
                                                        @foreach ($categories as $categ)
                                                            <li><a
                                                                    href="{{ route('shop_category', ['category_id' => $categ->id]) }}">{{ $categ->title }}</a>
                                                            </li>
                                                        @endforeach
