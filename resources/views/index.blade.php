                ...
                <div class="col-12">
                    <div class="product-info">
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                @foreach ($all_categories as $c)
                                    <li class="nav-item"><a
                                            ...
                                            data-toggle="tab" href="#{{ $c->title }}"
                                            role="tab">{{ $c->title }}</a></li>
                                @endforeach
                            </ul>
                            <!--/ End Tab Nav -->
                        </div>
                        <div class="tab-content" id="myTabContent">
                            ...
                            @foreach ($all_categories as $c)
                                <!-- Start Single Tab -->
                                <div class="tab-pane @if ($loop->first) fade show  active @endif"
                                    id="{{ $c->title }}" role="tabpanel">
                                    <div class="tab-single">
                                        <div class="row">


                                            @foreach ($c->products as $produit)
                                                <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                                                    <div class="single-product">
                                                        <div class="product-img">
                                                            <a href="{{ route('product', $produit->id) }}">
                                                                @if ($produit->image)
                                                                    <img class="default-img"
                                                                        src="{{ env('APP_IMAGE') }}{{ $produit->image }}"
                                                                        alt="#">
                                                                    <img class="hover-img"
                                                                        src="{{ env('APP_IMAGE') }}{{ $produit->image }}"
                                                                        alt="#">
                                                            ...
                                                            <div class="button-head">
                                                                <div class="product-action">
                                                                    <a data-toggle="modal"
                                                                        data-target="#showmodal{{ $produit->id }}"
                                                        ...
                                                        <div class="product-content">
                                                            <h3><a
                                                                    href="{{ route('product', $produit->id) }}">{{ $produit->title }}</a>
                                                            </h3>
                            ...
                            <div class="single-product">
                                <div class="product-img">
                                    <a href="product-details.html">
                                        ...
                                        @endif
                                        @if ($p->best_seller)
                                        <span class="out-of-stock">best_seller</span>
                                    @endif
                                    </a>
                                    <div class="button-head">
                                        <div class="product-action">
